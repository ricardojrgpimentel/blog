...
export default function Home({
  ...
  return (
    <>
      ...
      <div>
        <h1 className="text-2xl xl:text-3xl mb-4 font-extrabold leading-9 tracking-tight text-bigTitle dark:text-gray-100 sm:leading-10 md:leading-14">
          Últimas publicações
        </h1>
        <ul>
              ...
              <li key={slug} className="py-2">
                <article className="flex justify-between">
                  <h2 className="text-2xl font-semibold leading-8 tracking-tight">
                    <Link href={`/blog/${slug}`} className="text-bigTitle dark:text-gray-100">
                      {title}
                    </Link>
                  </h2>
                  <dl>
