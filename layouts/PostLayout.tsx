              ...
              {(next || prev) && (
                <div className="grid grid-cols-1 py-2 xl:grid-cols-2">
                  {prev && (
                    <Link
                      href={`/blog/${prev.slug}`}
                      className="p-5 xl:mr-1 mb-1 xl:mb-0 rounded-md transition duration-500 ease-in-out bg-gray-500 bg-opacity-5 hover:bg-opacity-20"
                    >
                  ...
                  {next && (
                    <Link
                      href={`/blog/${next.slug}`}
                      className="p-5 rounded-md transition duration-500 ease-in-out bg-gray-500 bg-opacity-5 hover:bg-opacity-20 text-right"
                    >
                      <h2 className="text-xs tracking-wide text-gray-500 uppercase dark:text-gray-400">
                        Publicação SEguinte
                      </h2>
